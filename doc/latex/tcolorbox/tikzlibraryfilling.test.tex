...
\usepackage{tikz}
\usetikzlibrary{filling}

% simulations
\usepackage{doc} % for \meta etc.

\newenvironment{dispExample}{\par}{}
\newenvironment{dispExample*}[1]{\par}{}

\NewDocumentEnvironment{docTikzKey}{ O{} O{} m m m }
  {\noindent\textcolor{magenta}{\ttdetoken{/tikz/#3}}\par}
  {\par}
\NewDocumentCommand{\docAuxCommand}{ s m }{\texttt\textbackslash\ttdetoken{#2}}

\newcommand{\refKey}[1]{\ttdetoken{#1}}

% helper
\newcommand{\ttdetoken}[1]{\texttt{\detokenize{#1}}}

\begin{document}
\section{Ti\emph{k}Z library \texttt{filling}}
